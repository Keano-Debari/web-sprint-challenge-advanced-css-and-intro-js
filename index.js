...
function getArtistByIndex(array, index) {
  ...
  return `the artist at index ${string.id} is ${string.name}`
}  
...
function addArtist(array){
    array.push({ 
      id: 20,
      name: 'Keano DeBari', 
      years: '1994 - April, 2021',
      genre: 'Web Design', 
      nationality: 'Multi-race',
      bio: 'lorem awedaw  awedawe fselres  klsrjes f hsejfh. fshefs fsef.'
    } );
    return array
  }
